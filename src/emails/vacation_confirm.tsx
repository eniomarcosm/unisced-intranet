...
interface VacationConfirmEmailProps {
  name?: string
...
export const VacationConfirmEmail = ({ name, start_date, end_date, days, subject }: VacationConfirmEmailProps) => {
  ...
  return (
    <Html>
      <Head />
      <Preview>Resposta de Solicitação</Preview>
      <Body style={main}>
        <Container>
          <Section style={content}>
            ...
            <Row style={{ ...boxInfos, paddingBottom: '0' }}>
              <Column>
                <Heading style={{ fontSize: 32, fontWeight: 'bold', textAlign: 'center' }}>{name},</Heading>
            ...
            <Row style={{ ...boxInfos, paddingTop: '0' }}>
              <Column style={containerButton} colSpan={2}>
                <Button href='http://localhost:3000/ferias/historico' style={button}>
                  Dar Resposta
                </Button>
              </Column>
            </Row>
...
VacationConfirmEmail.PreviewProps = {
  name: 'Enio Marcos',
  start_date: new Date(),
  end_date: new Date(),
  days: 0
} as VacationConfirmEmailProps

export default VacationConfirmEmail
