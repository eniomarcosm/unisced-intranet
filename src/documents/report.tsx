...
export const Document = ({ id, date, total }: { id: number; date: string; total: number }) => (
  <Tailwind>
    <div className='font-sans'>
      ...
      <main className='text-slate-800 pt-24 h-[90vh] flex flex-col'>
        ...
        <h1 className='text-center text-2xl text-slate-800'>Receipt from Acme Inc.</h1>
        ...
        <div className='p-12 flex-grow bg-white rounded-2xl rounded-t-none shadow-xl shadow-black/10'>
          <div className='flex justify-between gap-4'>
            <div>
              <div className='text-sm text-gray-400 font-bold uppercase pb-1'>Amount paid</div>
              <div className='flex gap-4 items-center'>${total}</div>
            </div>
            <div>
              <div className='text-sm text-gray-400 font-bold uppercase pb-1'>Date</div>
              <div className='flex gap-4 items-center'>{new Date(date).toLocaleString()}</div>
            </div>
            <div>
              <div className='text-sm text-gray-400 font-bold uppercase pb-1'>Payment method</div>
          ...
          <h2 className='text-slate-600 font-bold text-sm py-6 pt-12 uppercase'>Summary</h2>
          ...
          <hr className='my-6' />
          This is some additional content to to inform you that Acme Inc. is a fake company and this is a fake receipt.
          This is just a demo to show you how you can create a beautiful receipt with Onedoc.{' '}
          <Footnote>
            Some additional conditions may apply. This template comes from the react-print library, available at
